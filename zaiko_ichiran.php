	...
	<form action="zaiko_ichiran.php" method="post" id="myform" name="myform">
		<div id="pagebody">
			...
			<div id="left">
				...
				<button type="submit" id="btn1" formmethod="POST" name="decision" value="5" formaction="delete_product.php">新商品追加機能</button>

				<button type="submit" id="btn1" formmethod="POST" name="decision" value="6" formaction="new_product.php">商品削除機能</button>
			</div>
			<!-- 中央表示 -->
			<div id="center">
